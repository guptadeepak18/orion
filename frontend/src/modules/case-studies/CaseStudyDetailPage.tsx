...
export const CaseStudyDetailPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-24 max-w-7xl mx-auto">
      ...
      <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-900 p-4 sm:p-6 md:p-8 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
        {/* Pills & Badges Row */}
        <div className="flex flex-wrap items-center gap-2">
          {caseStudy.publisher_source && (
            <span className="px-3 py-1 rounded-full text-xs font-extrabold uppercase bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 flex items-center gap-1.5 shrink-0">
              <Building2 className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" /> {caseStudy.publisher_source}
            </span>
          )}
          {caseStudy.industry_domain && (
            <span className="px-3 py-1 rounded-full text-xs font-extrabold uppercase bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 flex items-center gap-1.5 shrink-0">
          ...
          {caseStudy.product_number && (
            <button
              ...
              className="px-3 py-1 rounded-full text-xs font-mono font-bold bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 flex items-center gap-1.5 transition-colors cursor-pointer shrink-0"
          ...
          {caseStudy.accessibility_status && (
            <span className="px-2.5 py-1 rounded-full text-[11px] font-bold uppercase bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 flex items-center gap-1 shrink-0">
        ...
        {/* Case Title */}
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-[32px] font-black tracking-tight text-slate-900 dark:text-white leading-tight">
          {caseStudy.title}
        </h1>

        {/* Author Byline */}
        {caseStudy.author && (
          <div className="text-xs sm:text-sm font-semibold text-slate-600 dark:text-slate-300 flex items-center gap-1.5 pt-0.5 flex-wrap">
      ...
      {/* Mode Switcher Tabs */}
      <div className="flex items-center gap-2 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 overflow-x-auto touch-scroll no-scrollbar max-w-full">
        <button
