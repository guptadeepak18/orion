    ...
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 animate-fadeIn">
          {/* Full-Width Single Row: 8 Interactive Module Cards */}
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
            ...
            {/* 8. Subject Gradebook Card */}
            <div
              onClick={() => navigateToTab('gradebook')}
              className="cursor-pointer rounded-2xl border border-amber-200/90 dark:border-amber-900/50 bg-gradient-to-b from-amber-50/60 to-white dark:from-amber-950/30 dark:to-slate-900 p-3.5 space-y-2.5 hover:shadow-md hover:border-amber-400 dark:hover:border-amber-600 transition-all flex flex-col justify-between group shadow-2xs"
            >
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() => navigateToTab('syllabus')}
                    className="inline-flex items-center gap-1 text-xs font-bold text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer"
                  >
                  ...
                  >
                    <Award className="h-3.5 w-3.5" /> Open Subject Gradebook →
                  </button>
                </div>
              </div>
