  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#060919] text-slate-900 dark:text-slate-100 flex flex-col justify-between relative overflow-hidden transition-colors duration-300">
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center p-3 sm:p-6">
        <div className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-slate-200/80 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl space-y-6">
          {/* Step Indicator */}
          ...
          {step === 1 && (
            <form onSubmit={handleRequestOtp} className="space-y-5">
              ...
              <div className="text-center pt-2">
                <Link
                  to="/login"
                  className="text-xs text-slate-500 hover:text-cyan-600 dark:text-slate-400 dark:hover:text-cyan-400 inline-flex items-center gap-1.5 transition-colors font-medium"
                >
          ...
          {step === 2 && (
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-xs mx-auto">
                  We have sent a 6-digit verification code to <span className="font-semibold text-cyan-600 dark:text-cyan-400 break-all">{email}</span>.
                </p>
              </div>
              ...
              <div className="flex justify-center gap-1.5 sm:gap-2.5 my-2">
                {otp.map((digit, idx) => (
                  <input
                    ...
                    className="w-9 h-12 sm:w-11 sm:h-13 text-center text-lg sm:text-xl font-bold font-mono bg-slate-50 dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-800 rounded-lg sm:rounded-xl text-slate-900 dark:text-white focus:outline-none focus:border-cyan-500 focus:bg-cyan-50/10 transition-all shadow-inner"
                  />
                ))}
              </div>
