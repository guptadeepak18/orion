      ...
      <div className="w-full max-w-lg z-10">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl p-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
            {step === 1
              ? 'Use your official @mile.education email to register'
              : step === 2
          ...
          >
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => set('prn_number', e.target.value)}
                    required
                  />
                </div>
            ...
            {step === 3 && (
              <>
                ...
                <div className="p-3.5 rounded-2xl bg-cyan-50/60 dark:bg-cyan-950/20 border border-cyan-200/80 dark:border-cyan-800/60 space-y-3">
                  <p className="text-xs font-bold text-cyan-900 dark:text-cyan-300 uppercase tracking-wider">
                    Program Specialization Choice
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      >
                        <option value="None / Not Decided">None / Not Decided</option>
                        {SPECIALIZATIONS.filter((s) => s !== form.specialization_major).map((s) => (
                          <option key={s} value={s}>
                            {s}
                          </option>
                        ))}
                ...
                {/* UG Degree Dropdown from Admin Portal */}
                <div>
                  <label className={labelCls}>
                    Undergraduate (UG) Degree <span className="text-rose-500">*</span>
                  </label>
                  <select
                    className={inputCls}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.01"
                      className={inputCls}
                      placeholder={form.ug_score_type === 'cgpa' ? '0.00 – 10.00' : '0 – 100'}
                      value={form.ug_score}
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-700 dark:bg-cyan-500 dark:hover:bg-cyan-600 text-white text-sm font-semibold transition-colors disabled:opacity-50 cursor-pointer"
              >
                {loading ? (
                  'Submitting...'
                ) : step < 3 ? (
